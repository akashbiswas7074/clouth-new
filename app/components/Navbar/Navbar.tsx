...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-[#f5f5f0] shadow-md py-2 flex justify-between items-center fixed top-0 z-10"> 
      ...
      <div className="flex items-center space-x-4">
        ...
        onClick={()=>{
         ...
         className="bg-[#e8e6da] text-[#4a2b2b] px-4 py-1 rounded-sm shadow-lg">Login</button>
...

      {
        login && (
          ...
          <div className='absolute w-[100vw] h-[200vw] bg-[#262525ab] flex justify-center items-center text-white'>
          <Login
          login={login}
          setLogin ={setLogin}
          />
