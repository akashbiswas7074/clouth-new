    ...
    return (
        <>
            <div className="w-full h-[500px] flex">
                {galleryImages.map((e) => (<img src={e} alt="Norway" className="w-1/3 h-full object-cover" />))}



            </div>
            <div className="bg-white mt-12 mb-10 flex flex-col items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="max-w-5xl text-gray-500 leading-relaxed mb-7">
